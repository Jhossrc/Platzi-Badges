...
class BadgeDetails extends React.Component {
  ...
  logo = "https://static.platzi.com/media/tmp/class-files/git/platzi-badges/platzi-badges-20.DetallesDeUnBadge/src/images/platziconf-logo.svg";
      ...
      <div>
        <div className='BadgeDetails__hero'>
          <div className='container'>
            <div className='row'>
              <div className='col-6'>
                <img src={this.logo} alt='Logo de la Conferencia' />
              </div>
